...
def corr(first_file, second_file):
  ...
  prediction2 = first_df.columns[1]
  # correlation
  print("Finding formation correlation between: {} and {}".format(first_file,second_file))
  ...
  print("Finding bandgap correlation between: {} and {}".format(first_file,second_file))
  print("Column to be measured: {}".format(prediction2))
  print("Pearson's correlation score: {}".format(first_df[prediction2].corr(second_df[prediction2],method='pearson')))
  print("Kendall's correlation score: {}".format(first_df[prediction2].corr(second_df[prediction2],method='kendall')))
  print("Spearman's correlation score: {}".format(first_df[prediction2].corr(second_df[prediction2],method='spearman')))
